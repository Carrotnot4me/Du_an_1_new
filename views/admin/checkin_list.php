    ...
    <div class="app">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav>
                ...
                <a class="nav-item active" href="index.php?action=checkin_list"><i class="bi bi-calendar-check-fill me-2"></i> Quy trình Check-in</a> 
        ...
        <main class="main flex-grow-1 p-4">
            ...
            <div class="p-4 bg-white rounded shadow-sm mb-4">
                <form method="GET" class="d-flex" action="index.php"> 
                    ...
                    <input type="text" name="keyword" class="form-control me-2" placeholder="Tìm kiếm theo Tên Tour, Code Tour, hoặc ID Booking" 
                            ...
                            <?php if (!empty($bookings)): ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-start text-truncate" style="max-width: 180px;"><?php echo htmlspecialchars($booking['tour_name']) . ' (' . htmlspecialchars($booking['tour_code']) . ')'; ?></td>
                                        <td class="text-center"><strong><?php echo date('d-m-Y', strtotime($booking['departureDate'])); ?></strong></td>
                                        <td class="text-center"><?php echo $booking['quantity']; ?></td>
                                        <td class="text-start text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($booking['customer_email']); ?></td>
                                        ...
                                        <td class="text-center">
                                            <?php if ($is_checked_in): ?>
                                                ...
                                                <small class="d-block text-muted"><?php echo date('H:i d-m', strtotime($checkin_time)); ?></small>
                                            <?php else: ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="8" class="text-center text-muted p-3">Không tìm thấy Booking cần Check-in nào.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </div>
                </table>
