...
    
    <nav>
      <a class="nav-item" href="index.php?action=dashboard"><i class="bi bi-house-door-fill"></i> Trang quản trị</a>
      <a class="nav-item active" href="index.php?action=tour-list"><i class="bi bi-airplane"></i> Quản lý Tour</a>
...
          <tr>
            <th>STT</th><th>Loại Tour</th><th>Tên Tour</th><th>Điểm đến</th><th>Hình ảnh</th><th>Mã tour</th><th>Giá cả</th><th>Hành động</th>
          </tr>
        </thead>
        <tbody></tbody>
      </table>
...
        <form id="addTourForm">
                            </form>
        <div id="formContentPlaceholder"></div>
      </div>
    </div>
  </div>
</div>
...
    <div class="modal-content">
      <div class="modal-header"><h5 class="modal-title">Chọn địa điểm trên bản đồ</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
      <div class="modal-body">
        <input type="text" id="searchLocation" class="form-control mb-2" placeholder="Tìm kiếm địa điểm...">
        <div id="mapContainer" style="height:400px;"></div>
        <div class="mt-2 p-2 bg-light rounded"><strong>Vị trí đã chọn:</strong> <span id="selectedLocation">Chưa chọn</span></div>
      </div>
...
        <a class="btn btn-info btn-sm" href="index.php?action=editTour&id=${t.id}"><i class="bi bi-pen"></i></a>
